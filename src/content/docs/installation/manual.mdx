...
<InstallationCommands
  ...
  npmCommand="npm install @base-ui-components/react motion clsx tailwind-merge tailwind-variants"
  pnpmCommand="pnpm add @base-ui-components/react motion clsx tailwind-merge tailwind-variants"
  yarnCommand="yarn add @base-ui-components/react motion clsx tailwind-merge tailwind-variants"
  bunCommand="bun add @base-ui-components/react motion clsx tailwind-merge tailwind-variants"
/>
...
Add the following code to your `lib/utils.ts` file.
